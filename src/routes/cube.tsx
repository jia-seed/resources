...
function Cube() {
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p>i'm still not where i want to be in terms of solving rubik's cubes. it's been 37 days and i'm down to 23 seconds. however, i do really like it. 
        this was my progression i'm breaking down here. i started 4/12/2026 and did beginner's method on day 1, then i learned f2l on 4/19, day 8. on 4/29, day 18, i was enjoying f2l and beginner's ll, which got me down to 36 seconds.
        ...
        now it's 5/18 and i woke up in the morning and solved it in 23.52 seconds. i'm currently learning full oll and pll + xcross. enjoy the resources!</p>
