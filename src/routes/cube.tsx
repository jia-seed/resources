...
function Cube() {
  return (
    <div style={{ padding: '0 4rem 4rem' }}>
      ...
      <p>on day 33 i met a cuber guy who solves it in 7 seconds at vivarium (who is now an amazing friend), then told him to school me at noisebridge the next day. he taught me to start the cross on the bottom and have no cube rotations for f2l. i think i had gotten a 25 second pr after midnight of that day before i met with him. 5/16 i immediately got my dopamine hit with the new bottom cross 1 orientation method working on 5/16 and got 24 seconds.
